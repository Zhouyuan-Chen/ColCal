...
bool ColCal_Tri::collide(const ColCal_Tri& tri, ColCal_Mat4& M,bool considerParallel) {
	// M * tri's points
	ColCal_Vec4 V0_(this->Points[0].x, this->Points[0].y, this->Points[0].z);
	ColCal_Vec4 V1_(this->Points[1].x, this->Points[1].y, this->Points[1].z);
	ColCal_Vec4 V2_(this->Points[2].x, this->Points[2].y, this->Points[2].z);
	...
	// for this triangle's three points
	ColCal_Vec3 V0(V0_[0], V0_[1], V0_[2]);
	ColCal_Vec3 V1(V1_[0], V1_[1], V1_[2]);
	ColCal_Vec3 V2(V2_[0], V2_[1], V2_[2]);
